...
class Student:
    ...
    def __init__(self, first, last, GPA, address, year):
    ...
    def print_name(self):
        print(f"The name of this student is {self.first_name} {self.last_name}. They have a GPA of {self.GPA_score} and their address is {self.address}.")

student_1 = Student("John", "Johnson", 3, "Bridgewater, MA")
# print(student_1.GPA_score)
